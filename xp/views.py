...
def dumpDB():
    ...
    mysqldump_cmd = "mysqldump -u " + db_User_Name + " --password='" + DB_User_Password + "' -h xmlparse.mysql.pythonanywhere-services.com --databases '" + DB_Name + "' --ignore-table= 'xmlparse$xmlparser.xp_xmldata' > " + backupDir + "/" + "dump.sql"
